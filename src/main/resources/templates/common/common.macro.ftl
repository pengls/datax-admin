            ...
            <div class="navbar-custom-menu">
                ...
                <#-- login user -->
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
							<#if Session["user"]?exists>${Session["user"].name}<#else>admin</#if>，欢迎您！
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="javascript:common.changeSkin('skin-blue');">skin-blue</a></li>
                            <li><a href="javascript:common.changeSkin('skin-black');">skin-black</a></li>
                            <li><a href="javascript:common.changeSkin('skin-red');">skin-red</a></li>
                            <li><a href="javascript:common.changeSkin('skin-yellow');">skin-yellow</a></li>
                            <li><a href="javascript:common.changeSkin('skin-purple');">skin-purple</a></li>
                            <li><a href="javascript:common.changeSkin('skin-green');">skin-green</a></li>
                            <li><a href="javascript:common.changeSkin('skin-blue-light');">skin-blue-light</a></li>
                            <li><a href="javascript:common.changeSkin('skin-black-light');">skin-black-light</a></li>
                            <li><a href="javascript:common.changeSkin('skin-red-light');">skin-red-light</a></li>
                            <li><a href="javascript:common.changeSkin('skin-yellow-light');">skin-yellow-light</a></li>
                            <li><a href="javascript:common.changeSkin('skin-purple-light');">skin-purple-light</a></li>
                            <li><a href="javascript:common.changeSkin('skin-green-ligh');">skin-green-ligh</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
	...
	<aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "task">active</#if>"><a href="${request.contextPath}/task"><i
                        class="fa fa-tasks text-aqua"></i><span>任务管理</span></a></li>
                <li class="nav-click <#if pageName == "dts">active</#if>"><a href="${request.contextPath}/dts"><i
                        class="fa fa-database text-green"></i><span>数据源管理</span></a></li>
                <li class="nav-click <#if pageName == "node">active</#if>"><a href="${request.contextPath}/node"><i
                        class="fa fa-paper-plane text-yellow"></i><span>Datax节点管理</span></a></li>
